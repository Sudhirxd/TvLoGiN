...
[![Telegram Bot](https://img.shields.io/badge/Telegram_Bot-@NetflixTv__loginbot-2CA5E0?style=for-the-badge&logo=telegram)](https://t.me/NetflixTv_loginbot)
...
```mermaid
flowchart TD
    A[📺 Open App on Smart TV] --> B[🔑 Note Activation Code / QR Code]
    B --> C[💬 Open Telegram Bot: @NetflixTv_loginbot]
    C --> D{Choose Input Method}
    D -->|Method 1: Direct Command| E[🤖 Bot retrieves active Session Cookie]
    D -->|Method 2: Send Code Directly| F[👇 Select Platform Button] --> E
    D -->|Method 3: Upload JioHotstar QR| G[📸 OCR Scans QR Code] --> E
    E --> H[🌐 Authenticates via Cookie Engine & Proxies]
    H --> I[🎉 Smart TV Successfully Unlocked!]
```

![Smart TV Activation Workflow](https://imgh.in/host/pnwhrv)
